...
from engine.Evaluation.metrics import precision, precision_recall_min_denominator, recall, MAP, MAP_MIN_DEN, MRR, HIT_RATE, ndcg, arhr_all_hits, \
...
class Evaluator(object):
    ...
    def _compute_metrics_on_recommendation_list(self, test_user_batch_array, recommended_items_batch_list, scores_batch, results_dict):
        ...
        for batch_user_index in range(len(recommended_items_batch_list)):
            ...
            relevant_items = self.get_user_relevant_items(test_user) # relevant items refer to items available in test data for user u. 
