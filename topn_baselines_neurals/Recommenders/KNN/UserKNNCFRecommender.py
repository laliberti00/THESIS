...
from topn_baselines_neurals.Recommenders.BaseSimilarityMatrixRecommender import BaseUserSimilarityMatrixRecommender
...
class UserKNNCFRecommender(BaseUserSimilarityMatrixRecommender):
    ...
    def fit(self, topK=454, shrink=1000, similarity='cosine', normalize=True, feature_weighting = "none", URM_bias = False, **similarity_args):
