...
from topn_baselines_neurals.Recommenders.BaseSimilarityMatrixRecommender import BaseItemSimilarityMatrixRecommender

from topn_baselines_neurals.Recommenders.IR_feature_weighting import okapi_BM_25, TF_IDF
import numpy as np

from topn_baselines_neurals.Recommenders.Similarity.Compute_Similarity import Compute_Similarity
...
class ItemKNNCFRecommender(BaseItemSimilarityMatrixRecommender):
    ...
    def fit(self, topK=516, shrink=1000, similarity='cosine', normalize=True, feature_weighting = "TF-IDF", URM_bias = False, **similarity_args):
